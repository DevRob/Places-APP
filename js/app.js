...
$(function() {
  ...
  function nhViewModel() {
    ...
    var self = this,
        ...
        categories = ['art_gallery', 'cafe', 'church', 'movie_theater', 'museum'],
        //styles = [],
        styledMap,
    ...
    setInterval(function(){
      /**
       * Checking mobilSlider position every 1200ms and move it to
       *   next item found if moved and out of position.
       */
      ...
      if (currentScrollValue !== parseInt(currentScrollValue, 10)) {
        if (currentScrollValue < lastScrollValue) {
          mobilSlider(0);
          console.log(currentScrollValue, lastScrollValue);
